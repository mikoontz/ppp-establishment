...
popSize_xvals <- offset_xvals(1:4, 0.2)
...
pdf("figures/population-size-absolute-7-and-relative-3-time-experiment-and-simulations.pdf", height = 3.14961, width = 2 * 3.14961)
# postscript("figures/population-size-absolute-7-and-relative-3-time-experiment-and-simulations.eps", height = 3.14961, width = 2 * 3.14961)
...
#
# Now the population size at 3 generations after the final introduction event
#
